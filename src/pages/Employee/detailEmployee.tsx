      ...
      <AnimatePresence>
          <>
              <motion.div className="flex items-center justify-end ">
                  ...
                  <div
                      className=" w-100 bg-white shadow-2xl rounded-lg flex flex-col absolute top-0 overflow-y-auto h-screen custom-scroll smooth-scroll mx-2.5 ">
                          ...
                          <div className="flex-1 no-scrollbar p-4">
                              ...
                              <div className="flex items-center justify-between mb-4">
                                  <div className="flex items-center gap-4">
                                      ...
                                      <div>
                                          <h3 className="text-base font-bold text-gray-900">{detailEmployee.fullName}</h3>
                    ...
                    <span className="w-1 h-1 bg-green-600 rounded-full"></span> Full-time
                              ...
                              <div className="space-y-4 mb-4">
                                  <div>
                                      <label className="block text-sm font-normal text-gray-900 mb-0.5 ">Address</label>
                                      <p className="text-xs text-gray-500 leading-relaxed">Jl. Rajawali I No.999 Blok C, 69412,
                                          Kec.
                                  ...
                                  <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                                      <div>
                                          <label className="block text-sm font-normal text-gray-900 mb-1 leading-6">Phone</label>
                                      ...
                                      <div>
                                          <label className="block text-sm font-normal text-gray-900 mb-1 leading-6 ">Email</label>
                                      ...
                                      <div>
                                          <label className="block text-sm font-normal text-gray-900 mb-1 leading-6">Date of
                                              birth</label>
                                          <div className="flex items-center gap-2 text-xs text-gray-500">
                                              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                      ...
                                      <div>
                                          <label className="block text-sm font-normal text-gray-900 mb-1 leading-6">Salary</label>
                                          <div className="flex items-center gap-2 text-xs text-gray-500">
                                              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                              ...
                              <div className="date_of_contract rounded-xl border border-gray-100 mb-4 p-1">
                                  ...
                                  <div className="bg-white px-3 py-3 rounded-xl">
                                      ...
                                      <div
                                          className="date_of_contract flex  items-start gap-2 text-xs text-gray-500 bg-gray-50 p-2 rounded-lg">
                              ...
                              <div className="border-b border-gray-200 mb-6">
                                  <div className="flex">
                                      <button
                                          className="py-2 px-3.5 tracking-wider  text-orange-500 font-medium text-sm flex items-center   ">
                                          Progress task
                                          <span
                                              className="bg-gray-200 text-gray-600 px-1.5 ml-2 py-0.5 rounded text-[12px] w-5 h-5">4</span>
                                      </button>
                                      ...
                                      <button
                                          ...
                                          Complete task
                                          <span
                                              className="bg-gray-200 text-gray-600 px-1.5 ml-2 py-0.5 rounded text-[12px] w-5 h-5">14</span>
                                      </button>
                                  </div>
                              </div>
                              ...
                              <div className="space-y-4 pb-4">
                                  ...
                                  <div className="border border-gray-200 rounded-xl p-3 shadow-sm bg-white">
                                      <div
                                          className="inline-block px-2 py-1 text-green-600 text-[10px] font-medium rounded-md border border-gray-300 mb-1.5">
                                          Deadline: 28 Feb 2025
                                      </div>
                                      <h5 className="text-sm font-medium text-gray-900 mb-0.5">Redesign website for Indomie</h5>
                                      <p className="text-xs text-gray-400 font-light mb-2">Revamp the website with a fresh and
                      ...
                      <div
                          className="border-t border-gray-200 p-4 bg-white flex items-center justify-between flex-shrink-0 z-10">
                          <button
