...
// Giữ nguyên các import hình ảnh của bạn
...
export default function SliderBar() {
    ...
    // 1. Thêm state quản lý trạng thái đóng/mở
    ...
    return (
        ...
        >
            ...
            <div className={`p-3 flex items-center ${isCollapsed ? 'justify-center flex-col gap-4' : 'justify-between'}`}>
                <div className={`flex items-center gap-2 transition-opacity duration-200 ${isCollapsed ? 'hidden' : 'opacity-100'}`}>
                ...
                <div className="mb-3">
                  ...
                  `}
                                >
                                    ...
                                    {!isCollapsed && (
                                        <span className="flex-1 text-sm font-normal text-left whitespace-nowrap overflow-hidden">
                        {item.title}
                    </span>
                                    )}
            ...
            {!isCollapsed && (
                <div className="px-3 py-4 space-y-4 transition-opacity duration-300">
                    <div className="bg-white rounded-lg p-3 border border-gray-100 shadow-sm">
                        ...
                        <button className="w-full py-2 px-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all">
                            Upgrade plan
                        </button>
                    </div>
                </div>
            ...
            {isCollapsed && (
                <div className="p-3 flex justify-center pb-6">
                    <button className="p-2 bg-white rounded-lg shadow hover:bg-gray-50 border border-gray-200" title="Upgrade Plan">
